...
## News
* 🎉 **2025-11-16**: Achieved nearly 5× faster decoding with KV-cache–enabled self-speculative decoding compared to HuggingFace Transformers’ vanilla autoregressive decoding (3B), See [self_speculative_generate_cached](https://github.com/OpenGVLab/SDLM/blob/main/sdlm_generator.py#L286).
